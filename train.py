...
def setup(args, resume_training=False, checkpoint_name=None):
...
def train(args):
    ...
    model, optim, criterion = setup(args, resume_training=args.resume, checkpoint_name=args.checkpoint_name )
    # Load dataloaders
...
if __name__=='__main__':
    ...
    parser.add_argument('--factor', default=6, type=int, help="Factor LR scheduler")
    parser.add_argument('--warmup', default=8000, type=int, help="Warmup LR scheduler")
    parser.add_argument('--restart', default=100, type=int, help="Restart LR scheduler")
